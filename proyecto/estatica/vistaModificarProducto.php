		...
		<div class="contenido">
			<div class="formulario">
					<form action="includes/formModificaProducto.php?id=<?=$_REQUEST['id']?>" method="POST">
						...
						<textarea name= "descripcionCorta" rows="4" cols="40" placeholder=<?$_REQUEST['desc']?><?= $_REQUEST['desc']?></textarea> 
						<p><h2>Descripción larga del producto:</h2> </p>
						<textarea  rows="10" cols="40" name= "descripcionLarga" placeholder=<?$_REQUEST['desl']?><?= $_REQUEST['desl']?></textarea> 
						<p><h2>Stock</h2> </p>
